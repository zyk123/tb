...
public class TcPackageAndPackageType implements Serializable {
    ...
    private List<TcFlowPackage> packageList;

    public List<TcFlowPackage> getPackageList() {
		return packageList;
	}

	public void setPackageList(List<TcFlowPackage> packageList) {
