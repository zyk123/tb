...
<div class="page_container">
    <div class="page_screen banner">
        <img src="<%=basePath%>static/images/banners/blue_top_table_banner.jpg" alt="">
    </div>
...
<div class="mask_layout bg_coloured"  id="aqmask" style="display: none;">
        <div class="tips_box" data-aqbox="p4" id="tips_boxp" style="display: none;height: 5rem;" >
            <div class="title">
...
<script type="text/javascript">
	...
	var browseUrl = "toolbar/postLotteryRewardinformation.jsp";
	...
	recordVist('${suid}');
	    ...
	    $("#oopsConfirm").on("click",function () {
	        $("#aqmask").hide();
	        $(this).parents(".tips_box").hide();
	        window.location.href="<%=basePath%>page/turnPostLucky?suid=${param.suid}&promotionId=6c6c3b249e3d4577bd27940e5e3cb847";
	    });	 
...
// 							alert('sucess');
                            ...
                            $("#aqmask").show();
							$("#tips_boxp").show();
							//window.location.href="<%=basePath%>page/turnPostLucky?suid=${param.suid}&promotionId=6c6c3b249e3d4577bd27940e5e3cb847&serviceType=${param.serviceType}";     
						}else{
...
// 						alert("etwork anomaly");
				...
				recordClickEvent('${suid}','toolbar/postLotteryRewardinformation.jsp/rewardSub');			               
        });
    });
    
    function goBackNotice(){
    	recordClickEvent('${suid}','toolbar/postLotteryRewardinformation.jsp/goBackLucky');	
    	window.location.href="<%=basePath%>page/turnPostLucky?suid=${param.suid}&promotionId=6c6c3b249e3d4577bd27940e5e3cb847&serviceType=${param.serviceType}";	
    	//history.back();
    }    
</script>
