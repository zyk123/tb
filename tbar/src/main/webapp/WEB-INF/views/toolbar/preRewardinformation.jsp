...
<header class="usage fixed-top tb_header"><i class="icon_back" id="goBackNotice" onclick="goBackNotice();"></i><h2>Congratulations</h2><i class="close_i"> </i></header>
    ...
    <div class="page_screen banner">
        <div class="bg_infomation">
                <div class="inner_cont">
                    ...
                    <p class="cont">Please fill in the following information so that you can receive the prize.</p>
                </div>
        </div>
    </div>
...
<script type="text/javascript">
	...
	var browseUrl = "toolbar/preRewardinformation.jsp";
...
// 							alert('sucess');
				...
				recordClickEvent('${suid}','toolbar/preRewardinformation.jsp/rewardSub');			               
        });
    });
    
    function goBackNotice(){
    	recordClickEvent('${suid}','toolbar/preRewardinformation.jsp/goBackNotice');		
    	history.back();
    }
</script>
</body>
