        ...
        <c:forEach var="item" items="${list}" varStatus="status">
            <li>
                <div class="page_screen banner ">
                   	<img src="<%=basePath%>${item.bannerUrl}" alt="" id="turnPostLucky" onclick="goPostLucky('${item.promotionId}')">
...
<script type="text/javascript">
		...
		var browseUrl = "toolbar/postPromotion.jsp";
		recordVist('${suid}');
		
		function goPostLucky(promotionId){
			recordClickEvent('${suid}','toolbar/postPromotion.jsp/turnPostLucky');	
			if(promotionId=='6c6c3b249e3d4577bd27940e5e3cb847'){
				window.location.href = "<%=basePath%>page/turnPostLucky?suid=${suid}&promotionId=6c6c3b249e3d4577bd27940e5e3cb847";
			}else{
