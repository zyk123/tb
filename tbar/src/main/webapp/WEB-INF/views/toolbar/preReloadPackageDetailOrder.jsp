...
<script type="text/javascript">
		...
		var browseUrl = "toolbar/preReloadPackageDetailOrder.jsp";
		recordVist('${suid}');
		
		function goBackStore(){
			recordClickEvent('${suid}','toolbar/preReloadPackageDetailOrder.jsp/goBackStore');		
// 			javascript :history.back();
            window.location.href="<%=basePath%>page/turnReload?suid=${suid}&flag=Y&flagamount=${flagamount}";
		}
		function buy(){
// 					$(".confrim").hide();
// 					$("#waitDiv").show();
