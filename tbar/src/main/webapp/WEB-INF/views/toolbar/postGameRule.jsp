...
<body class=" bgc_p1 after_payfor"  data-ctrl-name="pageview" style="background-color: #f5da88;" >
...
<script type="text/javascript">
		...
		var browseUrl = "toolbar/postGameRule.jsp";
		recordVist('${suid}');
	
	function jumpCompetition(){
		recordClickEvent('${suid}','toolbar/postGameRule.jsp/jumpCompetition');
