...
<script type="text/javascript">
	...
	var browseUrl = "toolbar/preReceiverInfo.jsp";
...
// 							alert('sucess');
				...
				recordClickEvent('${suid}','toolbar/preReceiverInfo.jsp/rewardSub');			               
        });
    });
    
    function goBackNotice(){
    	recordClickEvent('${suid}','toolbar/preReceiverInfo.jsp/goBackNotice');		
    	history.back();
    }
</script>
</body>
