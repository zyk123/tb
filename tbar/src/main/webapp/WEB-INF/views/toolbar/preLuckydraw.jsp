...
<body class="bgc_p2" data-ctrl-name="pageview">
	...
	<div class="fullscreen_container">
		<div class="page_screen banner ">
			...
			<img src="<%=basePath%>static/images/banners/luckbanner.jpg" alt="">
		</div>
...
<!-- 					<spring:message code="preluckydraw.exclamation.mark" /> -->
	...
	var browseUrl = "toolbar/preLuckydraw.jsp";
	recordVist('${suid}');
       ...
       $.ajax({
        ...
        $.ajax({
            ...
            $("#onedaytime").text(($("#onedaytime").text()>0 ? $("#onedaytime").text()-1:0)+" ");
             ...
             recordClickEvent('${suid}','toolbar/preLuckydraw.jsp/clickLottery');
        });
        ...
        recordClickEvent('${suid}','toolbar/preLuckydraw.jsp/btnyes1');
        })
        ...
        recordClickEvent('${suid}','toolbar/preLuckydraw.jsp/btnyes2');
        })
        ...
        $(".btnno").on("click",function (e) {
            ...
            recordClickEvent('${suid}','toolbar/preLuckydraw.jsp/btnno');
        })
        ...
        $(".iclose").on("click",function(){
            ...
            recordClickEvent('${suid}','toolbar/preLuckydraw.jsp/iclose');
        });
        ...
        $("#oopsConfirm").on("click",function(){
         ...
         $(".confirm_my").on("click",function(){
            ...
            $(this).parents(".tips_box").hide();
            $("body").css("overflow","auto");
            recordClickEvent('${suid}','toolbar/preLuckydraw.jsp/confirm_my');
        });
        
        $(".record_wrap").on("click",function(){
            window.location.href="<%=basePath%>page/turnNotice?suid=${suid}&isJumpCompetition=2";
            recordClickEvent('${suid}','toolbar/preLuckydraw.jsp/record_wrap');
        });
    };
...
//当滚动条到达右边顶端时
    ...
    function  jumpPromotion(){
		recordClickEvent('${suid}','toolbar/preLuckydraw.jsp/jumpPromotion');
