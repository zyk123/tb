...
<header class="usage fixed-top tb_header"><i class="icon_ac" style="visibility: hidden;"></i><h2>Successful</h2><i class="close_i" onclick="javascript:window.close();"> </i></header>

<div class="fullscreen_container pt-40p">
    <div class="order_cont">
        <div class="status_icon">
            <img src="<%=basePath%>static/images/icon/SuccessPic.png" alt="">
        </div>
        <div class="order_text">
            <p class="status_text">${reloadPackage} Reload Successful</p>
            <p class="order_p">You have successfully reloaded</p>
