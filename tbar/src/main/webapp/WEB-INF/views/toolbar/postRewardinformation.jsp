...
<script type="text/javascript">
	...
	var browseUrl = "toolbar/postRewardinformation.jsp";
...
// 							alert('sucess');
				...
				recordClickEvent('${suid}','toolbar/postRewardinformation.jsp/rewardSub');			               
        });
    });
    
    function goBackNotice(){
    	recordClickEvent('${suid}','toolbar/postRewardinformation.jsp/goBackNotice');		
    	history.back();
    }    
</script>
</body>
