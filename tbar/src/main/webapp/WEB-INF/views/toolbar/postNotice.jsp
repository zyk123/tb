...
<script type="text/javascript">
	...
	var browseUrl = "toolbar/postNotice.jsp";
	
	recordVist('${suid}');

	function jumpAccount(){
		recordClickEvent('${suid}','toolbar/postNotice.jsp/jumpAccount');		
		if(isJumpCompetition=='1'){
			...
			window.location.href='<%= basePath%>page/turnPostAccount?suid=${suid}';
		}	
	}

	function jumpRewardInfo(){
		window.location.href = "<%= basePath%>page/turnRewardInfo?suid=${suid}&receiverid=${receiverid}";
		recordClickEvent('${suid}','toolbar/postNotice.jsp/modifyOrAdd');	
	}
</script>
</body>
