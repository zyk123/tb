...
<header class="usage fixed-top tb_header"><i class="icon_ac" style="visibility: hidden;"></i><h2>Sorry</h2><i class="close_i" onclick="javascript:window.close();"> </i></header>

<div class="fullscreen_container pt-40p"><div class="order_cont">
    <div class="status_icon">
        <img src="<%=basePath%>static/images/icon/FailPic.png" alt="">
    </div>
    <div class="order_text">
        <p class="status_text">Reload Failed</p>
        <p class="order_p">Sorry! Your reload is failed.</p>
<!--         <p class="order_p">${returnCode}</p> -->
        <p class="order_p">${reasonDesc}</p>
        <a class="btn_ov btn_full c_ora mt-08r" href="#" onclick="javascript:window.close();">Back to Reload</a>
    </div>
</div></div>
