...
<header class="usage fixed-top tb_header"><i class="icon_back" id="g_close" onclick="invokeSelf('<%=basePath%>page/turnUsage?suid=${param.suid}','g_close')"></i><h2>Game</h2><i class="close_i"> </i></header>
...
<!-- 					<li style="display: block;"><img id="t_iph" onclick="invokeSelf('<%= basePath%>page/turnPackageDetailOrder?packageid=12&fgtips=Add-On Internet 500MB&fgno=45562&fgname=Add-On Internet 500MB&ptname=Add-OnInternet&fgdesc=Follow Internet plan validity period&amount=10.0000&currency=RM&expenses=&suid=${param.suid}','t_iph')" class="slideimg" src="<%=basePath%>static/images/banners/147/iph.jpg"  alt=""></li> -->
					<li style=" display: block;"><img id="t_chris" onclick="invokeSelf('<%=basePath%>page/turnPostLucky?suid=${param.suid}&promotionId=6c6c3b249e3d4577bd27940e5e3cb847','t_chris')" src="<%=basePath%>static/images/banners/147/ch.png"  alt=""></li>
...
<script>
	...
	function invoke(url,id){
		recordClickEvent('${param.suid}','toolbar/postGameList.jsp/'+id);
