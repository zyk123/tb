...
<body class="bgc_p2 pt-08r fullscreen bgc_p1"  data-ctrl-name="pageview" style="background-color: transparent; font-size:12px!imprtant;">
...
<script type="text/javascript">
    ...
    var browseUrl = "toolbar/preHome.jsp";
    recordVist('${suid}');
	...
	function invoke(url,id){
		recordClickEvent('${param.suid}','toolbar/preHome.jsp/'+id);
	...
	function ball_wave(per) {
        $(".flow_ball").attr("src",'<%=basePath%>static/images/tbBall/ballOutput/' + per + '.png');
    }
