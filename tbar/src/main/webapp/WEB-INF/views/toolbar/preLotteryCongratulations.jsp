...
<div class="page_container">
    <div class="page_screen banner">
        <img src="<%=basePath%>static/images/banners/topconban.jpg" alt="">
    </div>
...
<script type="text/javascript">
	...
	var browseUrl = "toolbar/preLotteryCongratulations.jsp";
...
// 						alert("etwork anomaly");
				...
				recordClickEvent('${suid}','toolbar/preLotteryCongratulations.jsp/rewardSub');			               
        });
    });
    
    function goBackNotice(){
    	recordClickEvent('${suid}','toolbar/preLotteryCongratulations.jsp/goBackLucky');
