       ...
       <div class="main_visual">
            <section class="main_image">
                <ul class="" style="width: 1678px; overflow: visible; ">
                    ...
                    <li style=" display: block;"><img id="t_chris" onclick="invoke_p('<%=basePath%>page/turnPreLucky?suid=${param.suid}&promotionId=6c6c3b249e3d4577bd27940e5e3cb847','t_chris')" src="<%=basePath%>static/images/banners/147/ch.png"  alt=""></li>
...
<script>
	...
	function invoke(url){
		...
		recordClickEvent('${param.suid}','toolbar/preNavigation.jsp/'+id);
