...
<div class="page_container">
    <div class="page_screen banner">
        <img src="<%=basePath%>static/images/banners/top_table_banner.jpg" alt="">
    </div>
...
<script type="text/javascript">
	...
	var browseUrl = "toolbar/preLotteryRewardinformation.jsp";
...
// 						alert("etwork anomaly");
				...
				recordClickEvent('${suid}','toolbar/preLotteryRewardinformation.jsp/rewardSub');			               
        });
    });
    
    function goBackNotice(){
    	recordClickEvent('${suid}','toolbar/preLotteryRewardinformation.jsp/goBackLucky');
