...
String orderId = "20170206154612118";
...
String responseUrl = "http://58.27.120.214:8080/tbar/toolbar/credit_reload_response.jsp";
...
%>
	...
	<div id="view" align="center">
		<table>
					<form id="merchant" name="merchant" method="post" action="https://onlinepayment.celcom.com.my/Payment-Testing/PrepaidPayment">
						<input type="text" name="orderId" id="orderId" value=<%=orderId%> /><br>
